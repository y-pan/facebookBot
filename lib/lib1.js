...
module.exports.getByHighestTagCount = (data, softLimit) => {
    ...
    console.log("----@@@1 getByHighestTagCount ends: size=" + data.length+ " |sl="+ softLimit);
    // console.log(tops);
    return tops;
}
...
module.exports.getOverlapCountOfArrays = (array1, array2) =>{
    let count = 0;
    let arri = array1.slice(0), arrj = array2.slice(0);  // slice, to clone a copy, not to modify the original ones
