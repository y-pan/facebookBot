...
// const pv_db_cloud_connection = process.env.db_cloud;

// if(!pv_db_cloud_connection){
//     pv_db_cloud_connection = "mongodb://fbAdmin:fbAdmin!234@ds117888.mlab.com:17888/facebookbot-db";
// }
// const dbConnectionStatus = "DB Connection Failure."
// mongoClient.connect(pv_db_cloud_connection, (err, db)=>{
//     if(!err){
//         dbConnectionStatus = "DB Connection Ready."
//     }
// })
...
module.exports.recognizeText_promise = (text) =>{
    return new Promise((resolve, reject) =>{
        ...
        reject("Sorry, lack of data to response, please try other keywords. DB status=" + dbConnectionStatus); //reject(feedback);  // nothing found
    });
}
