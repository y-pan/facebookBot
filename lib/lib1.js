...
module.exports.getByHighestTagCount = (data, softLimit) => {
    ...
    if(data.length <= softLimit) return data; // not enough elements already, just return whatever in arr
    ...
    console.log("[!!!!!!!!!!!!!!!] after sort by tagCount descending, data size: " + data.length);
    data.forEach(d => {
...
module.exports.getByLowestDistance = (data, hardLimit) => {
    console.log("[!!!!!!!!!!!!!!!] getByLowestDistance, data size: " + data.length);
    ...
    console.log("[!!!!!!!!!!!!!!!] end of getByLowestDistance, data size: " + tops.length);
    console.log(tops);
    return tops;
}
