...
module.exports.decideMessage = (sender, text)=>{
    ...
    {
        self.sendText(sender, vars.offerMenu1 + ", \n" + vars.offerMenu2);
    }else if(text.includes(vars.offerMenu3.toLowerCase()))
    {
        self.sendText(sender, "I guess you want menu3: " + vars.offerMenu3_1 + " oh yes");
    }else
    {
